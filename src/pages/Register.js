...
<div className="mt-offcanvas">
  <div className="mt-offcanvas-wrapper">
    ...
    <div className="mt-offcanvas-info mb-50">
      ...
      <span><a href="ss">Avenue de Roma 158b, Lisboa</a></span>
    </div>
 ...
 <section className="mt-login-area pt-120 pb-140 p-relative z-index-1 fix">
      ...
      <div className="mt-login-wrap mr-30">
        <div className="mt-login-top text-center mb-40">
          <h3 className="mt-login-title">Register</h3>
          <span>Please register to your account</span>
        </div>
        <div className="mt-login-option">
          ...
          <div className="mt-login-input-wrapper mb-20">
            <form onSubmit={handleSubmit}>
              <div className="row">
                ...
                <div className="col-md-12">
                  <div className="mt-checkout-input p-relative">
                    <input
                      type="password"
                ...
                <div className="mt-login-suggetions d-sm-flex align-items-center justify-content-between mb-30">
                  <div className="mt-login-remeber">
          ...
          <div className="mt-login-mail text-center p-relative mb-20">
            <p>Or Register With</p>
          </div>

          <div className="mt-login-social mb-20 d-flex flex-wrap align-items-center justify-content-center">
            <div className="mt-login-option-item">
              <a href="aa">
            ...
            <div className="mt-login-option-item">
              <a href="aa">
                <img className="apple" src="assets/img/contact/google.svg" alt="Google" />
                <span>Google</span>
              </a>
            </div>
          </div>
          ...
          <div className="mt-login-account text-center mb-30">
            ...
            <div className="col-xl-6 col-lg-6">
              <div
                className="mt-login-thumb br-40 text-center text-lg-end wow img-custom-anim-top"
                data-wow-duration="1.5s"
                data-wow-delay="0.1s"
              >
                <img src="assets/img/contact/login-thumb.jpg" alt="Register Thumb" />
              </div>
            </div>
          </div>
        </div>
