          ...
          <div className="row align-items-center">
            ...
            <div className="col-lg-10 col-6">
              <div className="mtheader__bottom-wrapper p-relative d-flex align-items-center justify-content-end justify-content-xl-between">
                ...
                </div> <div className="mtheader__midel-account-wrap p-relative d-flex align-items-center justify-content-between">
                  <div className="mtheader__midel-wishlist d-none d-lg-block">
...
<Unitary></Unitary>
    <section className="mt-team-details-area pt-130 pb-90">
      <div className="container">
        <div className="row">
          {/* Left Column - Image and Contact */}
          <div className="col-xl-5 col-lg-5">
            <div className="team-details-thumb br-15">
              <img
            ...
            <div className="team-details-thumb-bottom mt-30 mb-40">
              <div className="row align-items-center">
                <div className="col-6">
                  <div className="mt-team-call">
                    <a href="mailto:example@example.com">
                      Email Me <i className="far fa-phone"></i>
                    </a>
                  </div>
                </div>
                <div className="col-6">
                  <div className="mt-team-social-share text-end">
                    <div className="mt-postbox-social text-end">
                      <a href="a"><i className="fab fa-facebook-f"></i></a>
                      <a href="b"><i className="fab fa-twitter"></i></a>
                      <a href="c"><i className="fab fa-linkedin-in"></i></a>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="col-xl-7 col-lg-7">
            <div className="mt-team-details-content pl-70 mb-40">
              <div className="mt-section-content">
                <h3 className="mt-section-title mb-6">Ralph Edwards</h3>
                <span>Founder & CEO</span>
                <div className="mb-20"></div>
                <p>
                  As an artist here to solve such issues, we successfully filed several mandamus cases
                  on behalf of more than 250 artwork and their family members and had approved green
                  cards within several months after filing a complaint.
                </p>
              </div>

              {/* More Details */}
              <div className="mt-team-more-info mt-30">
                <h4 className="mt-team-sm-title mb-20">More details</h4>
                <ul>
                  <li><label>Location:</label> <span>Germany</span></li>
                  <li><label>Position:</label> <span>Founder & CEO</span></li>
                  <li><label>Email:</label> <span><a href="mailto:example@example.com">example@example.com</a></span></li>
                  <li><label>Age:</label> <span>35</span></li>
                  <li><label>Qualification:</label> <span>Master Degree</span></li>
                  <li><label>Gender:</label> <span>Male</span></li>
                </ul>
              </div>

              {/* Experience */}
              <div className="mt-team-exp-info mt-30">
                <h4 className="mt-team-sm-title mb-20">Experience</h4>
                <ul>
              ...
              {/* Skills */}
              <div className="mt-team-skill-info mt-30 mb-60">
                <h4 className="mt-team-sm-title mb-20">My Skill</h4>
                <div className="mt-skill-bar">
                  <div className="mt-skill-item mb-25">
                    <label>Concept</label>
                    <div className="progress-outer">
                      <span className="progress-num" style={{ left: "calc(80% - 31px)" }}>80%</span>
                      <div className="fix">
                        <div className="progress wow tpSkillInLeft" data-wow-duration="1s" data-wow-delay="0.2s" role="progressbar" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100">
                  ...
                  <div className="mt-skill-item mb-25">
                    ...
                    <div className="progress-outer">
                      <span className="progress-num" style={{ left: "calc(90% - 31px)" }}>90%</span>
                      <div className="fix">
                        <div className="progress wow tpSkillInLeft" data-wow-duration="1s" data-wow-delay="0.4s" role="progressbar" aria-valuenow="90" aria-valuemin="0" aria-valuemax="100">
                  ...
                  <div className="mt-skill-item mb-25">
                    ...
                    <div className="progress-outer">
                      <span className="progress-num" style={{ left: "calc(85% - 31px)" }}>85%</span>
                      <div className="fix">
                        <div className="progress wow tpSkillInLeft" data-wow-duration="1s" data-wow-delay="0.6s" role="progressbar" aria-valuenow="85" aria-valuemin="0" aria-valuemax="100">
              ...
              <div className="contact-form-box">
                <h4 className="mt-team-sm-title mb-20">Contact Me</h4>
                <form action="https://template.moontelict.com/rosun/assets/mail.php" method="post" id="contact-form">
                  <div className="row">
