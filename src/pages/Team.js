...
import Quardiant from '../components/Quardiant'
...
<main>
          ...
          <div className="col-lg-7">
            <div className="mt-breadcrumb p-relative">
              ...
              <div className="mt-breadcrumb-list">
                ...
                <span><a href="/Team">Your Team</a></span>
              </div>
            </div>
          </div>
    ...
    <Quardiant></Quardiant>
     <section className="mtteam__area pt-130 pb-90 p-relative">
      <div className="container">
        <div className="mt-section-content text-center mb-50">
          ...
          <p>
            Our dedicated team at FreshMart is here to make your shopping <br /> experience exceptional. Each member
            brings expertise.
          </p>
        </div>
          ...
          {teamMembers.map((member, index) => (
            <div className="col-xl-3 col-lg-4 col-md-6" key={index}>
              <div className="mtteam__wrapper p-relative fix mb-30">
                <div className="mtteam__item mtteam__border br-12">
                  ...
                  <div className="mtteam__info text-center">
                    ...
                    <div className="mtteam__member-social mt-30">
                      <a href="a"><i className="fa-brands fa-pinterest"></i></a>
