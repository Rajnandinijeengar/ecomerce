...
<BlogStart></BlogStart>
<section className="mt-blogpost-area pt-80 pb-55">
  <div className="container">
    <div className="row">
      {/* Blog Content */}
      <div className="col-xl-8 col-lg-8">
        <div className="mt-postbox-wrapper mr-35">

          {/* BLOG ITEM 1 */}
          <article className="mt-postbox mb-60 p-relative">
            <div className="mt-postbox-thumb mb-35 br-15">
              <a href="blog-details.html">
                <img src="assets/img/blog/blog-thumb-1.jpg" alt="Blog" />
              </a>
            </div>
            ...
            <div className="mt-postbox-content">
              <div className="mt-postbox-meta mb-15">
                <span className="date">
                  <a href="aa"><i className="fal fa-calendar-alt"></i> 20 MAR 2025</a>
                </span>
                <span>
                  <a href="aa"><i className="fal fa-user"></i> By Alison</a>
                </span>
                <span>
                  <a href="aa"><i className="fa-regular fa-comment"></i> 18 Comments</a>
                </span>
              </div>

              <h3 className="mt-postbox-title mb-10">
                <a href="blog-details.html">
              ...
              <p>
                Discover clever tips and tricks to streamline your grocery shopping experience.
              </p>

              <div className="mt-postbox-btn">
                <a className="mt-btn" href="blog-details.html">Read More</a>
              </div>
            </div>
          </article>
          ...
          {/* BLOG ITEM – SLIDER */}
          <article className="mt-postbox mb-60 p-relative">
            <div className="mt-postbox-thumb mb-35 p-relative">
              <div className="swiper mt-postbox-active">
                <div className="swiper-wrapper">
                  <div className="swiper-slide br-15">
                    <img src="assets/img/blog/blog-thumb-2.jpg" alt="Blog" />
                  </div>
                  <div className="swiper-slide br-20">
                    <img src="assets/img/blog/blog-thumb-3.jpg" alt="Blog" />
                  </div>
                  <div className="swiper-slide br-20">
                    <img src="assets/img/blog/blog-thumb-4.jpg" alt="Blog" />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="mt-postbox-content">
              <div className="mt-postbox-meta mb-15">
                <span><a href="aa"><i className="fal fa-calendar-alt"></i> 20 MAR 2025</a></span>
                <span><a href="aa"><i className="fal fa-user"></i> By Alison</a></span>
                <span><a href="aa"><i className="fa-regular fa-comment"></i> 18 Comments</a></span>
              </div>

              <h3 className="mt-postbox-title mb-10">
                <a href="blog-details.html">
                  Pantry Staples Building a Well-Stocked Kitchen
                </a>
              </h3>
          ...
          {/* BLOG ITEM – VIDEO */}
          <article className="mt-postbox mb-60 p-relative">
            <div className="mt-postbox-thumb mb-35 position-relative br-20">
              <img src="assets/img/blog/blog-thumb-3.jpg" alt="Blog" />
              <div className="mt-blog-video">
                <a
                  className="popup-video"
                  href="https://www.youtube.com/watch?v=oSO0Ehs2B3I"
                >
            ...
            <div className="mt-postbox-content">
              <h3 className="mt-postbox-title mb-10">
                <a href="blog-details.html">
                  Grocery Shopping Tips to Save You Time and Money
                </a>
              </h3>
          ...
          {/* BLOG ITEM – AUDIO */}
          <article className="mt-postbox mb-60 p-relative">
            <div className="mt-postbox-thumb mb-35 ratio ratio-16x9">
              <iframe
                title="SoundCloud"
                allow="autoplay"
                src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/1851673326"
              />
            </div>
            ...
            <div className="mt-postbox-content">
              <h3 className="mt-postbox-title mb-10">
                <a href="blog-details.html">
                  Grocery on a Budget – Delicious and Affordable Meals
                </a>
              </h3>
      ...
      <div className="col-xl-4 col-lg-4">
        <div className="mt-blog-sidebar-widget mb-40">
          <h3 className="mt-blog-sidebar-title mb-20">Search</h3>
          <form className="mt-blog-form position-relative">
        ...
        <div className="mt-blog-sidebar-widget mb-40">
          <h3 className="mt-blog-sidebar-title mb-20">Category</h3>
          <ul>
            <li><a href="aa">Fresh Products (10)</a></li>
            <li><a href="aa">Pantry Essentials (18)</a></li>
            <li><a href="aa">Health & Wellness (24)</a></li>
          </ul>
        </div>

        <div className="mt-blog-sidebar-widget mb-40">
          <h3 className="mt-blog-sidebar-title mb-20">Keywords</h3>
