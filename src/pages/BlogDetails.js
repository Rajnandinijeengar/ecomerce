      ...
      <div className="col-lg-7">
        <div className="mt-breadcrumb p-relative">
          ...
          <div className="mt-breadcrumb-list">
            ...
            <span>
              <a href="/BlogDetails">Blogs Details</a>
            </span>
          </div>
        </div>
      </div>
...
<Market></Market>
<section className="mt-blogpost-area pt-80 pb-40">
  <div className="container">
    <div className="row">
      {/* LEFT CONTENT */}
      <div className="col-xl-8 col-lg-8">
        <div className="mt-postbox-wrapper mr-35">
          <article className="mt-postbox mb-100">
            <div className="mt-postbox-thumb mb-30 br-15">
              <img src="assets/img/blog/blog-details.jpg" alt="Blog Details" />
            </div>

            <div className="mt-postbox-content mt-postbox-content-2">
              <div className="mt-postbox-meta mb-25">
                <span className="date">
              ...
              <p>
                Welcome to "Grocery on a Budget: Delicious and Affordable Meals,"
                your go-to blog for mastering tasty meals without breaking the bank.
              </p>

              <div className="row align-items-center">
                <div className="col-md-4 mb-30 br-20">
                  <img src="assets/img/blog/blog-details-sm1.jpg" alt="" />
                </div>
                <div className="col-md-8 mb-30">
                  <h3 className="mt-postbox-title-sm">Smart Shopping Tips:</h3>
                  <p>
                    Learn how to navigate the grocery store like a pro and save more.
                  </p>
                </div>
              </div>
              ...
              <div className="mt-postbox-tag-wrapper">
                <div className="row align-items-center">
                  ...
                  <div className="col-lg-5 text-end">
                    <div className="mt-postbox-social">
                      <span>Share:</span>
                      <a href="aa"><i className="fab fa-facebook-f"></i></a>
                      <a href="aa"><i className="fab fa-twitter"></i></a>
                      <a href="aa"><i className="fab fa-instagram"></i></a>
                      <a href="aa"><i className="fab fa-linkedin-in"></i></a>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div className="col-xl-4 col-lg-4">
        ...
        <div className="mt-blog-sidebar-widget mb-40">
          ...
          <ul>
            <li><a href="aa">Fresh Products</a></li>
            <li><a href="aa">Pantry Essentials</a></li>
            <li><a href="aa">Health & Wellness</a></li>
          </ul>
        </div>

        <div
          className="mt-blog-sidebar-widget mt-blog-sidebar-widget-subscribe mb-40"
          style={{
            backgroundImage: "url('assets/img/blog/subscribe-widget.jpg')",
            backgroundSize: "cover",
            backgroundPosition: "center"
          }}
        >
          <h3 className="mt-blog-sidebar-title mb-20">Subscribe</h3>
          <p>Subscribe to get daily blog updates</p>
          <form className="mt-blog-form position-relative">
        ...
        <div className="mt-blog-sidebar-banner br-15">
          <a href="aa">
            <img src="assets/img/blog/banner-widget.jpg" alt="Banner" />
          </a>
        </div>
      </div>
    </div>
